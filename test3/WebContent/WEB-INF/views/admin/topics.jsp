    ...
    <div id="page-wrapper">
        ...
        <table class="table table-striped table-hover table-users">
		  ...
		  <c:forEach var="title" items="${topics}" >
    					...
    					<td class="hidden-phone">${title.tid}</td>
    					<td><a href="showQuestions?Tid=${title.tid}">${title.name}</a></td>					<td><a class="btn mini blue-stripe" href="insertQuestion?Tid=${title.tid}">Insert</a></td></td>					<td><a class="btn mini blue-stripe" href="<%--updateTopic?Tid=${title.tid} --%>#">Update</a></td>

                        <td><a href="<%-- deleteTopicc?Tid=${title.tid}--%>#" class="confirm-delete btn mini red-stripe" role="button" data-title="johnny" data-id="1">Delete</a></td>
                    </tr>
                    </c:forEach>
        		</tbody>
